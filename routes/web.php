...
Route::group(['prefix' => LaravelLocalization::setLocale(), 'middleware' => ['referral']], function() {
    ...
    Route::group(['middleware' => ['auth:sanctum', 'verified']], function() {
        ...
        Route::group(['prefix' => config('bap.admin-prefix-url'), 'middleware' => ['auth:sanctum', 'verified', 'admin']], function () {
            ...
            Route::get('/order/index', \App\Http\Livewire\Admin\Order\Index::class)->name('admin.order.index');

            // Route::get('/subscription/create', \App\Http\Livewire\Admin\Subscription\Create::class)->name('admin.subscription.create');
